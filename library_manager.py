...
# 4) Sidebar
st.sidebar.markdown("<h1 style='text-align: center;'>📚 Navigation</h2>", unsafe_allow_html=True)
...
st.markdown(
    ...
    .main-header {
        ...
        animation: soft-move 2s ease-in-out infinite;
    }
    </style>

    <h1 class='main-header'>📖 Personal Library Manager</h1>
    """,
    unsafe_allow_html=True
)
...
if st.session_state.current_view == "add":
    ...
    with st.form(key='add_book_form'):
        ...
        with col2:
            genre = st.selectbox("Genre", [
                "Fiction", "Non-Fiction", "Science", "Technology", "Fantasy", "Romance", "Poetry",
                "Self-help", "Art", "Religion", "History"
            ])
    ...
    st.markdown("<h2 class='sub-header'>🏛️ Your Library</h2>", unsafe_allow_html=True)
...
<p><span class="{'read-badge' if book['read_status'] else 'unread-badge'}">{"Read" if book['read_status'] else "Unread"}</span></p>
    ...
    if not st.session_state.library:
        ...
        st.markdown("---")
        st.markdown("Copyright ©️ 2025 Ammar Khan Personal Library Manager", 
                    unsafe_allow_html=True)
